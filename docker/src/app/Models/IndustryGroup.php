...
class IndustryGroup extends Model
{
    ...
    const TYPE_CULTIVATION = 1;
    const STATUS_TYPE_LIST = [
        self::TYPE_NATURAL => '天然',
        self::TYPE_CULTIVATION => '養殖',
    ];
     ...
     * 梱包済の箱
     */
    public function reserve_packages()
    {
        return $this->hasMany('App\Models\Package')
            ->confirm()
            ->orderBy('id', 'asc');
    ...
    {
        return '〒' . $this->zip_code . ' ' . $this->prefecture_name . $this->address1 . $this->address2 . $this->address3;
    }
    ...
    {
        $address = $this->prefecture_name . '' . $this->address1;
        return $address;
    }

    public function getPickupAddressWithZipCodeAttribute()
    {
        return '〒' . $this->pickup_zipcode . ' ' . $this->pickup_prefecture_name . $this->pickup_address1 . $this->pickup_address2 . $this->pickup_address3;
    }

    public function getDisplayPickupAddressAttribute()
    {
        $address = $this->pickup_address1 . '' . $this->pickup_address2 . '' . $this->pickup_address3;
        return $address;
    }

    public function getDisplayAddress2Attribute()
    {
        $address = $this->address2 . '' . $this->address3;
        return $address;
    }
    ...
    {
        $users = User::where('industry_group_id', $this->id)
            ->select('email')
            ->where('type', 'MANAGER')
            ->pluck('email');
        return $users;
    ...
    public function getIndustryTelAttribute()
    {
        $input = $this->tel;
        $groups = array(
            5 =>
