...
@section('title', '荷主管理編集')
@section('content')
    <div class="l-base">
        @include('solaseed.element._aside')
        <main class="l-main">
            <div class="p-index l-container__600">
                <form action="{{ route('solaseed.partner.update') }}" method="post">
                    @csrf
                    ...
                    <div class="p-index__head">
                        ...
                        <p class="c-text__lv3 c-text__main c-text__weight--900 c-title">
                            ...
                            荷主管理<small class="c-text__lv5 c-text__main">編集</small>
                        </p>
                    </div>
                                                    ...
                                                    <div class="c-input--select c-input__150">
                                                        <select name="prefecture" class="form-control">
                                                            @foreach(config('prefecture') as $key => $val)
                                                                <option
                                                                    value="{{ $key }}"
                                                                    {{ $key == old('prefecture', $partner->prefecture) ? 'selected' : '' }}
                                                                >
                                                                    {{ $val }}
                                                                </option>
                                                            @endforeach
                                    ...
                                    <div class="l-auto">
                                        <ul class="p-list__col">
                                                ...
                                                <div class="c-input">
                                                    <div class="c-input">
                                                        <input type="text" required placeholder="姓"
                                                               ...
                                                               value="{{ old('responsible_last_name') ?? $partner->responsible_last_name }}">
                                                    </div>
                                                    <div class="c-input">
                                                        <input type="text" required placeholder="名"
                                                               name="responsible_first_name"
                                                               value="{{ old('responsible_first_name') ?? $partner->responsible_first_name }}">
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="c-input c-input__full">
                                                    <input type="text" placeholder="◯◯支店" name="bank_branch"
                                                           value="{{ old('bank_branch') ?? $partner->bank_branch }}">
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="c-input c-input__full">
                                                    <input type="text" placeholder="1234567890"
                                                           ...
                                                           value="{{ old('bank_account_number') ?? $partner->bank_account_number }}">
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="c-input c-input__full">
                                                    <input type="text" placeholder="株式会社サンプル" name="bank_account_holder"
                                                           value="{{ old('bank_account_holder') ?? $partner->bank_account_holder }}">
                                                </div>
