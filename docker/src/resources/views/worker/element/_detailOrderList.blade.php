    ...
    <div class="c-full">
        ...
        <div class="c-title">
            ...
            <div class="c-right f-a_center">
                <p class="c-text__lv3 c-text__weight--900 c-text__deep order_total_count">
                    <!-- 読み込みで表示 -->
                </p>
            </div>
        </div>
        <div class="c-box shadow">
            <div class="c-box__body">
                <table class="p-table">
                    ...
                    <th>
                        <p class="c-text__label--head">運送会社</p>
                    </th>
                    <th>
                        <p class="c-text__label--head">チェック</p>
                    </th>
                    <th>
                        <p class="c-text__label--head">選択</p>
                    </th>
                    </thead>
                    <tbody id="js-insert-orderList">
                    <!-- 読み込みで表示 -->
                    </tbody>
                </table>
                <!-- 表示情報がないとき -->
