    ...
    <div class="l-container__768 l-page">
        <section class="p-index">
            <div class="p-index__head">
                ...
                <h2 class="c-text__lv3 c-text__weight--900">従業員管理 <small>新規登録</small></h2>
            </div>
            <form action="{{ route('warehouse.labor.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                                        ...
                                        <div class="data">
                                            <div class="c-input c-input_300">
                                                <input type="text" name="service_id" placeholder="taro_yamada01xx"
                                                       value="{{old('service_id')}}" autocomplete="off">
                                            </div>
