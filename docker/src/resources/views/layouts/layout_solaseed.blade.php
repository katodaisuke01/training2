...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('solaseed/image/favicon/favicon.ico') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('solaseed/image/favicon/favicon.ico') }}">
    <link rel="mask-icon" href="{{ asset('solaseed/image/favicon/safari-pinned-tab.svg') }}" color="#00C4E5">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <title>@yield('title')</title>
    @yield('styles')
    <link rel="stylesheet" href="{{asset('solaseed/css/library/dataTables.min.css')}}">
    <link rel="stylesheet" href="{{asset('solaseed/css/library/dataTables.dateTime.min.css')}}">
    <link rel="stylesheet" href="{{asset('solaseed/css/styles.css')}}">
    <!-- 	font -->
...
@include('solaseed.element._footer')
<!-- フラッシュメッセージ -->
@include('market.element._flash')
<!-- モーダル_異常報告 -->
@include('solaseed.element._script')
