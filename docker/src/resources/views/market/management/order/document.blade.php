        ...
        <section class="p-index">
            <div class="p-index__head">
                ...
                <div class="c-buttonArea__end">
                    ...
                    <button id="sendDocumentMailButton" class="c-button__sub c-button__min">メールで送信</button>
                    <script>
                        $('#sendDocumentMailButton').on('click', function () {
                            if (confirm('顧客宛にメールが送信されます。よろしいですか？')) {
                                $('#sendMailSupply').submit();
                            }
                            ;
                        })
                    </script>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="c-text__min">{{ data_get($value, 'order_product.industry_group.name') }}
                                                    ・{{ data_get($value, 'shipping_date') ? data_get($value, 'shipping_date')->format('Y/m/d') : '' }}</p>
                                            </td>
                                            <td>
