            ...
            <form>
                <div class="p-index__body">
                    <div class="c-box">
                        <div class="p-index__body--title">
                            <p class="title c-text__main c-text__weight--900">アカウント情報</p>
                            <div class="c-buttonArea__end">
                                <a class="c-button__sub c-button__min" href="{{ route('pwEdit') }}">パスワード登録</a>
                            </div>
                        </div>
                        <div class="l">
                ...
                <div class="p-index__foot">
                    <div class="c-buttonArea__bottom c-buttonArea__end">
                        ...
                        <a href="{{route('industry.staffEdit')}}" class="c-button__round c-button__wide ">編集する</a>
                    </div>
                </div>
            </form>
