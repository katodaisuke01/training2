        ...
        <section class="c-box c-box__600">
            ...
            <div class="p-modal__foot">
                <div class="c-buttonArea__center">
                    ...
                    <form action="{{ route('admin.staff.destroy', [$staff]) }}" id="delete_form" method="post">
                        @csrf
                        <input type="hidden" name="id" id="staff_delete_id">
                        <button type="submit" class="c-button c-button__round c-button__gray c-button__min" id="">削除する
                        </button>
                    </form>
                </div>
            </div>
