...
<table width="100%" border="0" cellpadding="10" cellspacing="0">
    ...
    <tr>
        <td class="responsive" valign="top">
            <a href="{{ route('solaseed.order.index') }}" style="display: block; margin: 0; width: 180px;">
        ...
        <td>
            <table width="100%" border="0" cellpadding="10" cellspacing="0" style="margin: 0 0 40px;">
                ...
                <tr>
                  ...
                  font-weight: bold;
                ">
                            <b style="padding: 0 10px 0 0; font-size: 18px;">注文のお知らせ</b>
                        </font>
                    </td>
                </tr>
                </tbody>
                ...
                <tr>
                    <td class="responsive bg_none " valign="top" style="padding: 0;">
                        <font size="3" color="#333333" style="font-size: 15px;line-height: 1.7;color: #333333;">
                            {{ $business_name }} から商品発注がありました。<br>
                            注文内容の詳細については<a href="{{ route('solaseed.order.index') }}">こちら</a>よりご確認ください。<br><br>
                        </font>
                    </td>
                </tr>
                <tr>
            ...
            <table width="100%" border="0" cellpadding="10" cellspacing="0"
                ...
                ">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="responsive" valign="top">
                                        <a href="{{ route('solaseed.order.index') }}"
