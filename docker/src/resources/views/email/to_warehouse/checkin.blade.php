...
<table width="100%" border="0" cellpadding="10" cellspacing="0">
    ...
    <tr>
        <td class="responsive" valign="top">
            <a href="{{ route('warehouse.home') }}" style="display: block; margin: 0; width: 180px;">
        ...
        <td>
            <table width="100%" border="0" cellpadding="10" cellspacing="0" style="margin: 0 0 40px;">
                ...
                <tr>
                  ...
                  font-weight: bold;
                ">
                            <b style="padding: 0 10px 0 0; font-size: 18px;">置き配のお知らせ</b>
                        </font>
                    </td>
                </tr>
                </tbody>
                ...
                <tr>
                    <td class="responsive bg_none " valign="top" style="padding: 0;">
                        <font size="3" color="#333333" style="font-size: 15px;line-height: 1.7;color: #333333;">
                            置き配があります。<br>
                            詳細については<a href="{{ route('warehouse.home') }}">こちら</a>よりご確認ください。<br><br>
                        </font>
                    </td>
                </tr>
                <tr>
