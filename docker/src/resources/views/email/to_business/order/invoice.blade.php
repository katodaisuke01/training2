        ...
        <td>
            <table width="100%" border="0" cellpadding="10" cellspacing="0" style="margin: 0 0 40px;">
                ...
                <tr>
                  ...
                  font-weight: bold;
                ">
                            <b style="padding: 0 10px 0 0; font-size: 18px;">請求のお知らせ</b>
                        </font>
                    </td>
                </tr>
                </tbody>
                ...
                <tr>
                    <td class="responsive bg_none " valign="top" style="padding: 0;">
                        <font size="3" color="#333333" style="font-size: 15px;line-height: 1.7;color: #333333;">
                            {{ $business_name }} 御中<br><br>

                            平素よりお世話になっております。<br>
                            {{ $industry_name }}をご利用頂きましてありがとうございます。<br>
                            ご請求書のご確認をお願いします。<br>
                            下記のリンクからご請求書の印刷が可能です。<br>
                            <a href="{{ $link }}">請求書印刷画面を開く</a><br><br>
