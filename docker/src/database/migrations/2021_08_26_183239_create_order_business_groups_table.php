...
class CreateOrderBusinessGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('order_business_groups', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('order_business_groups');
    }
}
