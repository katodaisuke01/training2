  ...
  @component('component.company.frame._default')
    ...
    <div class="c-box bg-fff">
      <div class="c-buttonArea__center">
        <a href="{{route('companyEntryCreate')}}" class="c-button">新規作成</a>
      </div>
    </div>
    <div class="c-box">
      <div class="p-grid">
        <ul class="p-list__split5">
        <?php
          function cardList(){
            return [
              [
        ...
        @foreach($cardList as $card)
          <li class="fadeInUp c-card" data-input="{{ $card['density'] }}">
            <div class="c-card--content {{ $card['color'] }}">
              <a href="{{ route('companyEntryDetail') }}"></a>
              <div class="hover">
                <div class="c-buttonArea__center">
                  <a href="{{route('companyEntryEdit')}}" class="c-button__min c-button__line--white">編集</a>
                </div>
              </div>
              <div class="c-upper">
